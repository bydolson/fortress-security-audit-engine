...
from fortress.detectors.abstract_detector import AbstractDetector
...
from fortress.detectors.attributes.locked_ether import LockedEther
from fortress.detectors.erc.incorrect_erc20_interface import IncorrectERC20InterfaceDetection
from fortress.detectors.erc.incorrect_erc721_interface import IncorrectERC721InterfaceDetection
from fortress.detectors.erc.unindexed_event_parameters import UnindexedERC20EventParameters
from fortress.detectors.examples.backdoor import Backdoor
from fortress.detectors.functions.arbitrary_send import ArbitrarySend
from fortress.detectors.functions.external_function import ExternalFunction
from fortress.detectors.functions.suicidal import Suicidal
from fortress.detectors.naming_convention.naming_convention import NamingConvention
from fortress.detectors.operations.block_timestamp import Timestamp
from fortress.detectors.operations.low_level_calls import LowLevelCalls
from fortress.detectors.operations.unchecked_low_level_return_values import UncheckedLowLevel
from fortress.detectors.operations.unchecked_send_return_value import UncheckedSend
from fortress.detectors.operations.unused_return_values import UnusedReturnValues
from fortress.detectors.operations.void_constructor import VoidConstructor
from fortress.detectors.reentrancy.reentrancy_eth import ReentrancyEth
from fortress.detectors.reentrancy.reentrancy_events import ReentrancyEvent
from fortress.detectors.shadowing.abstract import ShadowingAbstractDetection
from fortress.detectors.shadowing.builtin_symbols import BuiltinSymbolShadowing
from fortress.detectors.shadowing.local import LocalShadowing
from fortress.detectors.shadowing.state import StateShadowing
from fortress.detectors.source.rtlo import RightToLeftOverride
from fortress.detectors.statements.assembly import Assembly
from fortress.detectors.statements.calls_in_loop import MultipleCallsInLoop
from fortress.detectors.statements.controlled_delegatecall import ControlledDelegateCall
from fortress.detectors.statements.incorrect_strict_equality import IncorrectStrictEquality
from fortress.detectors.statements.too_many_digits import TooManyDigits
from fortress.detectors.statements.tx_origin import TxOrigin
from fortress.detectors.variables.possible_const_state_variables import ConstCandidateStateVars
from fortress.detectors.variables.uninitialized_local_variables import UninitializedLocalVars
from fortress.detectors.variables.uninitialized_state_variables import (
    UninitializedStateVarsDetection,
)
from fortress.detectors.variables.uninitialized_storage_variables import UninitializedStorageVars
...
def test_detector(test_item: Test):
    set_solc(test_item)
    sl = Fortress(test_item.test_file)
