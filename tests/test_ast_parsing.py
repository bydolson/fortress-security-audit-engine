...
FORTRESS_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TEST_ROOT = os.path.join(FORTRESS_ROOT, "tests", "ast-parsing")
...
def get_tests(solc_versions) -> Dict[str, List[str]]:
    ...
    """
    fortress_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    test_dir = os.path.join(fortress_root, "tests", "ast-parsing")
...
def generate_output(sl: Fortress) -> Dict[str, Dict[str, str]]:
    output = {}
