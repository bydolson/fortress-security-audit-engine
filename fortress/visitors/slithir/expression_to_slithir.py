...
from fortress.core.solidity_types import ArrayType, ElementaryType
...
from fortress.slithir.tmp_operations.argument import Argument
...
from fortress.slithir.variables import (
    Constant,
    ReferenceVariable,
    TemporaryVariable,
    TupleVariable,
...
class ExpressionToSlithIR(ExpressionVisitor):
    def __init__(self, expression, node):  # pylint: disable=super-init-not-called
        from fortress.core.cfg.node import NodeType  # pylint: disable=import-outside-toplevel
