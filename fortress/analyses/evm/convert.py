import logging
from fortress.core.declarations import Contract, Function
...
from fortress.analyses.evm.evm_cfg_builder import load_evm_cfg_builder
...
def generate_source_to_evm_ins_mapping(evm_instructions, srcmap_runtime, fortress, filename):
    """
    ...
    file_source = fortress.source_code[filename].encode("utf-8")
    prev_mapping = []
