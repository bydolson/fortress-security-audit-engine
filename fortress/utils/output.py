...
from fortress.core.declarations import Contract, Function, Enum, Event, Structure, Pragma
...
from fortress.exceptions import FortressError
...
class Output:
    ...
    def add_other(
        self, name: str, source_mapping, fortress, additional_fields: Optional[Dict] = None,
    ):
        ...
        if isinstance(source_mapping, tuple):
            ...
            source_id = next(
                (
                    source_unit_id
                    for (source_unit_id, source_unit_filename,) in fortress.source_units.items()
        ...
        if isinstance(source_mapping, str):
            ...
            source_mapping.set_offset(source_mapping_str, fortress)
