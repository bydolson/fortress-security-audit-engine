...
class IDCollision(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#functions-ids-collisions"
...
class FunctionShadowing(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#functions-shadowing"
