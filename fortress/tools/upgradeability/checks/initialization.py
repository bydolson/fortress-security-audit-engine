...
from fortress.slithir.operations import InternalCall
from fortress.tools.upgradeability.checks.abstract_checks import (
    AbstractCheck,
    CheckClassification,
)
from fortress.utils.colors import red

logger = logging.getLogger("Fortress-check-upgradeability")
...
class InitializablePresent(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initializable-is-missing"
...
"""
    ...
    def _check(self):
        initializable = self.contract.fortress.get_contract_from_name("Initializable")
...
class InitializableInherited(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initializable-is-not-inherited"
...
class InitializableInitializer(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initializer-is-missing"
...
class MissingInitializerModifier(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initializer-is-not-called"
...
class MissingCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initialize-functions-are-not-called"
...
class MultipleCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initialize-functions-are-called-multiple-times"
...
class InitializeTarget(AbstractCheck):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Upgradeability-Checks#initialize-function"
