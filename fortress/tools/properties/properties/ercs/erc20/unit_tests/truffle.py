...
from fortress.tools.properties.platforms.truffle import (
    generate_migration,
    generate_unit_test,
)
from fortress.tools.properties.properties.ercs.erc20.properties.initialization import ERC20_CONFIG
from fortress.tools.properties.properties.properties import Property
...
def generate_truffle_test(
    ...
    output_dir = Path(contract.fortress.crytic_compile.target)
