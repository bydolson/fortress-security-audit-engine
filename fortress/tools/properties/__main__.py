...
from fortress.tools.properties.properties.erc20 import generate_erc20, ERC20_PROPERTIES
from fortress.tools.properties.addresses.address import (
    Addresses,
    OWNER_ADDRESS,
    USER_ADDRESS,
    ATTACKER_ADDRESS,
...
def main():
    ...
    contract = fortress.get_contract_from_name(args.contract)
    if not contract:
        if len(fortress.contracts) == 1:
            contract = fortress.contracts[0]
        else:
