...
from fortress.tools.flattening.flattening import (
    Flattening,
    Strategy,
    STRATEGIES_NAMES,
    DEFAULT_EXPORT_PATH,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Contracts flattening. See https://github.com/crytic/fortress/wiki/Contract-Flattening",
        usage="fortress-flat filename",
    )
