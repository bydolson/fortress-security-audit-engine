...
from fortress.utils.erc import ERCS
...
logger = logging.getLogger("Fortress-conformance")
...
def main():
    ...
    fortress = Fortress(args.project, **vars(args))

    ret = defaultdict(list)

    if args.erc.upper() in ERCS:

        contract = fortress.get_contract_from_name(args.contract_name)
