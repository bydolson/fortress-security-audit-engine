...
simil_logger = logging.getLogger("Fortress-simil")
compiler_logger = logging.getLogger("CryticCompile")
compiler_logger.setLevel(logging.CRITICAL)
fortress_logger = logging.getLogger("Fortress")
fortress_logger.setLevel(logging.CRITICAL)
...
def encode_contract(cfilename, **kwargs):
    ...
    # Init fortress
    try:
        fortress = Fortress(cfilename, **kwargs)
