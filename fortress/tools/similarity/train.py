...
from fortress.tools.similarity.cache import save_cache
from fortress.tools.similarity.encode import encode_contract, load_contracts
from fortress.tools.similarity.model import train_unsupervised
