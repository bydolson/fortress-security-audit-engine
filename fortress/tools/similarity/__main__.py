...
from fortress.tools.similarity.info import info
from fortress.tools.similarity.test import test
from fortress.tools.similarity.train import train
from fortress.tools.similarity.plot import plot

logging.basicConfig()
logger = logging.getLogger("Fortress-simil")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Code similarity detection tool. For usage, see https://github.com/crytic/fortress/wiki/Code-Similarity-detector"
    )
