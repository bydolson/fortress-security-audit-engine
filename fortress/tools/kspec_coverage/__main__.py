...
from fortress.tools.kspec_coverage.kspec_coverage import kspec_coverage
...
def main():
    # ------------------------------
    #       Usage: fortress-kspec-coverage contract kspec
    #       Example: fortress-kspec-coverage contract.sol kspec.md
    # ------------------------------
    # Parse all arguments
