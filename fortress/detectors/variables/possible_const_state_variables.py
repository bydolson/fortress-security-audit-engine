...
from fortress.formatters.variables.possible_const_state_variables import custom_format
...
class ConstCandidateStateVars(AbstractDetector):
    ...
    def _detect(self):
        ...
        all_functions = [c.all_functions_called for c in self.fortress.contracts]
