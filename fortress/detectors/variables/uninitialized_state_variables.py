...
from fortress.slithir.operations import InternalCall, LibraryCall
...
class UninitializedStateVarsDetection(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#uninitialized-state-variables"
...
"""
    ...
    def _variable_written_in_proxy(self):
        ...
        for c in self.fortress.contracts:
