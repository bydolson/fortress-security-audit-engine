...
class ConstantFunctionsAsm(AbstractDetector):
    ...
    ARGUMENT = "constant-function-asm"  # run the detector with fortress.py --ARGUMENT
    HELP = "Constant functions using assembly code"  # help information
    IMPACT = DetectorClassification.MEDIUM
    CONFIDENCE = DetectorClassification.MEDIUM

    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#constant-functions-using-assembly-code"
