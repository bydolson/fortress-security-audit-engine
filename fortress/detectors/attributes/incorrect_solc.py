...
from fortress.formatters.attributes.incorrect_solc import custom_format
...
class IncorrectSolc(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#incorrect-versions-of-solidity"
...
Consider using the latest version of Solidity for testing."""
    ...
    def _detect(self):
        ...
        if self.fortress.crytic_compile:
            if self.fortress.crytic_compile.compiler_version:
                if (
                    self.fortress.crytic_compile.compiler_version.version
