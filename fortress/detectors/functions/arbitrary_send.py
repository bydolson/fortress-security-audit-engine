...
from fortress.analyses.data_dependency.data_dependency import is_tainted, is_dependent
...
class ArbitrarySend(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#functions-that-send-ether-to-arbitrary-destinations"
