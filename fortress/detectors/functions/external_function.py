...
from fortress.slithir.operations import SolidityCall
from fortress.slithir.operations import InternalCall, InternalDynamicCall
from fortress.formatters.functions.external_function import custom_format
...
class ExternalFunction(AbstractDetector):
    ...
    https://github.com/trailofbits/fortress/pull/53#issuecomment-432809950
    """
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#public-function-that-could-be-declared-external"
