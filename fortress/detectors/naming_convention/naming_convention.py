...
from fortress.formatters.naming_convention.naming_convention import custom_format
...
class NamingConvention(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions"
