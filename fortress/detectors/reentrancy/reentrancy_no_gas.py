...
from fortress.slithir.operations import Send, Transfer, EventCall
...
class ReentrancyNoGas(Reentrancy):
    ...
    WIKI = (
        "https://github.com/crytic/fortress/wiki/Detector-Documentation#reentrancy-vulnerabilities-4"
    )
