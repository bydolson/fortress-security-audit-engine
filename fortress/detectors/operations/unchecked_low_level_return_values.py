...
"""
from fortress.detectors.abstract_detector import DetectorClassification
...
class UncheckedLowLevel(UnusedReturnValues):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#unchecked-low-level-calls"
