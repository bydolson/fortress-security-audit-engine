...
class RightToLeftOverride(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#right-to-left-override-character"
...
"""
    ...
    def _detect(self):
        ...
        for filename, source in self.fortress.source_code.items():
            ...
            while True:
                ...
                relative = self.fortress.crytic_compile.filename_lookup(filename).relative
