...
from fortress.slithir.operations import Binary, Assignment, BinaryType, LibraryCall
...
class DivideBeforeMultiply(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#divide-before-multiply"
