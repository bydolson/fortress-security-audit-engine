...
from fortress.analyses.data_dependency.data_dependency import is_tainted
...
class ControlledDelegateCall(AbstractDetector):
    ...
    WIKI = "https://github.com/crytic/fortress/wiki/Detector-Documentation#controlled-delegatecall"
