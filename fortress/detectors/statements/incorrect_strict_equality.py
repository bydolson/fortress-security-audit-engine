...
from fortress.analyses.data_dependency.data_dependency import is_dependent_ssa
...
from fortress.core.solidity_types import MappingType, ElementaryType
...
class IncorrectStrictEquality(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/crytic/fortress/wiki/Detector-Documentation#dangerous-strict-equalities"
    )
