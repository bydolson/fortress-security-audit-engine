...
from fortress.core.solidity_types.elementary_type import Int, Uint
...
class TypeBasedTautology(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/crytic/fortress/wiki/Detector-Documentation#tautology-or-contradiction"
    )
