...
from fortress.core.solidity_types.elementary_type import (
    ElementaryType,
    ElementaryTypeName,
)
from fortress.core.solidity_types.type import Type
from fortress.core.solidity_types.user_defined_type import UserDefinedType
from fortress.core.solidity_types.array_type import ArrayType
from fortress.core.solidity_types.mapping_type import MappingType
from fortress.core.solidity_types.function_type import FunctionType
...
if TYPE_CHECKING:
    from fortress.core.declarations import Structure, Enum
...
def parse_type(t: Union[Dict, UnknownType], caller_context):
    ...
    from fortress.solc_parsing.variables.function_type_variable import FunctionTypeVariableSolc
    ...
    structures = contract.structures + contract.fortress.top_level_structures
    enums = contract.enums + contract.fortress.top_level_enums
    contracts = contract.fortress.contracts
    ...
    if t[key] == "FunctionTypeName":
        ...
        for p in params[index]:
            var = FunctionTypeVariable()
            var.set_offset(p["src"], caller_context.fortress)
