...
from fortress.core.variables.structure_variable import StructureVariable
from fortress.solc_parsing.variables.structure_variable import StructureVariableSolc
...
class StructureSolc:  # pylint: disable=too-few-public-methods
    ...
    def analyze(self):
        for elem_to_parse in self._elemsNotParsed:
            ...
            elem.set_offset(elem_to_parse["src"], self._structure.contract.fortress)
