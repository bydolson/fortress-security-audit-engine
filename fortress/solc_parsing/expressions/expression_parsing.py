...
from fortress.core.declarations import Event, Enum, Structure
from fortress.core.declarations.contract import Contract
from fortress.core.declarations.function import Function
from fortress.core.declarations.solidity_variables import (
    SOLIDITY_FUNCTIONS,
    SOLIDITY_VARIABLES,
...
from fortress.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from fortress.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from fortress.core.expressions.elementary_type_name_expression import ElementaryTypeNameExpression
...
from fortress.core.expressions.new_elementary_type import NewElementaryType
from fortress.core.expressions.super_call_expression import SuperCallExpression
from fortress.core.expressions.super_identifier import SuperIdentifier
...
from fortress.core.expressions.unary_operation import UnaryOperation, UnaryOperationType
...
from fortress.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def parse_call(expression: Dict, caller_context):  # pylint: disable=too-many-statements
    ...
    if type_conversion:
        ...
        t.set_offset(src, caller_context.fortress)
        return t
    ...
    if isinstance(called, SuperCallExpression):
        ...
        sp.set_offset(expression["src"], caller_context.fortress)
        return sp
    call_expression = CallExpression(called, arguments, type_return)
    call_expression.set_offset(src, caller_context.fortress)
...
def _parse_elementary_type_name_expression(
    ...
    e.set_offset(expression["src"], caller_context.fortress)
    return e
...
def parse_expression(expression: Dict, caller_context: CallerContext) -> "Expression":
    ...
    if name == "UnaryOperation":
        ...
        unary_op.set_offset(src, caller_context.fortress)
        return unary_op
    ...
    if name == "BinaryOperation":
        ...
        binary_op.set_offset(src, caller_context.fortress)
        return binary_op
    ...
    if name == "Conditional":
        ...
        conditional.set_offset(src, caller_context.fortress)
        return conditional
    ...
    if name == "Assignment":
        ...
        assignement.set_offset(src, caller_context.fortress)
        return assignement
    ...
    if name == "Literal":
        ...
        literal.set_offset(src, caller_context.fortress)
        return literal
    ...
    if name == "Identifier":
        ...
        identifier.set_offset(src, caller_context.fortress)
        return identifier
    ...
    if name == "IndexAccess":
        ...
        index.set_offset(src, caller_context.fortress)
        return index
    ...
    if name == "NewExpression":
        ...
        if type_name[caller_context.get_key()] == "ArrayTypeName":
            ...
            array.set_offset(src, caller_context.fortress)
            return array
        ...
        if type_name[caller_context.get_key()] == "ElementaryTypeName":
            ...
            new_elem.set_offset(src, caller_context.fortress)
            return new_elem
        ...
        new.set_offset(src, caller_context.fortress)
        return new
    ...
    if name == "ModifierInvocation":
        ...
        call.set_offset(src, caller_context.fortress)
        return call
