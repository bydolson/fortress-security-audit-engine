...
from fortress.core.children.child_contract import ChildContract
from fortress.core.children.child_inheritance import ChildInheritance
from fortress.core.declarations.solidity_variables import (
    SolidityFunction,
    SolidityVariable,
    SolidityVariableComposed,
)
from fortress.core.expressions import (
    Identifier,
    IndexAccess,
    MemberAccess,
    UnaryOperation,
)
from fortress.core.solidity_types import UserDefinedType
...
from fortress.utils.utils import unroll

# pylint: disable=import-outside-toplevel,too-many-instance-attributes,too-many-statements,too-many-lines

if TYPE_CHECKING:
    from fortress.utils.type_helpers import (
        InternalCallType,
        LowLevelCallType,
        HighLevelCallType,
        LibraryCallType,
    ...
    from fortress.core.cfg.node import Node, NodeType
    from fortress.core.variables.variable import Variable
    from fortress.slithir.variables.variable import SlithIRVariable
    from fortress.slithir.variables import LocalIRVariable
    from fortress.core.expressions.expression import Expression
    from fortress.slithir.operations import Operation
...
class Function(
    ...
    def name(self) -> str:
        ...
        if self._function_type == FunctionType.CONSTRUCTOR_VARIABLES:
            return "fortressConstructorVariables"
        if self._function_type == FunctionType.CONSTRUCTOR_CONSTANT_VARIABLES:
            return "fortressConstructorConstantVariables"
        return self._name
    ...
    def can_reenter(self, callstack=None) -> bool:
        ...
        :return bool:
        """
        from fortress.slithir.operations import Call
    ...
    def is_constructor_variables(self) -> bool:
        ...
        Fortress has inbuilt functions to hold the state variables initialization
        """
    ...
    def return_values(self) -> List["SlithIRVariable"]:
        ...
        """
        from fortress.core.cfg.node import NodeType
        from fortress.slithir.operations import Return
    ...
    def _solidity_variable_in_internal_calls(node: "Node") -> List[SolidityVariable]:
        from fortress.slithir.operations.internal_call import InternalCall
    ...
    def new_node(self, node_type: "NodeType", src: Union[str, Dict]) -> "Node":
        ...
        node.set_offset(src, self.fortress)
    ...
    def _get_last_ssa_variable_instances(
        ...
        from fortress.slithir.variables import ReferenceVariable
        from fortress.slithir.operations import OperationWithLValue
        from fortress.core.cfg.node import NodeType
    ...
    def _unchange_phi(ir: "Operation"):
        from fortress.slithir.operations import Phi, PhiCallback
    ...
    def fix_phi(self, last_state_variables_instances, initial_state_variables_instances):
        from fortress.slithir.operations import InternalCall, PhiCallback
        from fortress.slithir.variables import Constant, StateIRVariable
    ...
    def generate_slithir_ssa(self, all_ssa_state_variables_instances):
        from fortress.slithir.utils.ssa import add_ssa_ir, transform_slithir_vars_to_ssa
        from fortress.core.dominators.utils import (
