...
class FortressCore(Context):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    """
    Fortress static analyzer
    """
    ...
    def __init__(self):
        ...
        self._previous_results_filename: str = "fortress.db.json"
        ...
        # If set to true, fortress will not catch errors during parsing
        ...
        for path in self._paths_to_filter:
            try:
                ...
                logger.error(
                    ...
                    "\nFortress supports the Python re format"
