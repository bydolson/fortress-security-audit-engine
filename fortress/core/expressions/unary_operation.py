...
from fortress.core.expressions.expression_typed import ExpressionTyped
from fortress.core.expressions.expression import Expression
from fortress.core.exceptions import FortressCoreError
...
class UnaryOperationType(Enum):
    ...
    def get_type(operation_type, isprefix):
        ...
        raise FortressCoreError("get_type: Unknown operation type {}".format(operation_type))
    ...
    def __str__(self):
        ...
        raise FortressCoreError("str: Unknown operation type {}".format(self))
    ...
    def is_prefix(operation_type):
        ...
        raise FortressCoreError("is_prefix: Unknown operation type {}".format(operation_type))
