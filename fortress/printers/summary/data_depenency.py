...
from fortress.analyses.data_dependency.data_dependency import get_dependencies
from fortress.slithir.variables import TemporaryVariable, ReferenceVariable
...
class DataDependency(AbstractPrinter):
    ...
    WIKI = "https://github.com/trailofbits/fortress/wiki/Printer-documentation#data-dependencies"
